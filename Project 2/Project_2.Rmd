...
> In conclusion, the number of new privately owned housing units started seems to have a definite inverse predictive relationship with the unemployment rate.  Large changes to HOUST generally preceed large changes in unemployment rate by a few months to a little over a year.
