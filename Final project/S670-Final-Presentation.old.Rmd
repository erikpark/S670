...
a) Catalog.data.gov - The data contains details like store/restaurant proximity, food prices, community characteristics etc.  

b) Factfinder.census.gov - Income details (median income) state and county level
...
__CONVSPTH07__ - Is a measure of the number of convenience stores in a county, per 1000 residents, in 2007.

__FSRPTH07__ - Is the same measure but for full service restaurants in a county, per 1000 residents, in 2007.
...
3) West region has more obese rate and diabetes rate   
...
5) In general, seems to be lower probability with lower poverty in general  
